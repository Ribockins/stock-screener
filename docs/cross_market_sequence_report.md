...
3. **NY 14:30** — US30/SPX500/NGAS/**XAUUSD** cluster; **XAGUSD** only if gold/US GEM confirm.
4. **NY 16:00** — **XAGUSD** standalone fade window (52% ≥50% retrace).
5. **Macro filter** — yesterday US30 ≤−1% → gold/silver/EU mild long bias (`macro_bias.json`).
