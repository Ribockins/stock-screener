...
class NGH4PremiumBacktester:
    ...
    def backtest(self):
        ...
        print("-" * 120)
        print(f"{'Date':<20} {'Price':<10} {'RSI':<8} {'Type':<10} {'Score':<8} {'RR':<8} {'ADX':<8} {'Profitable':<12} {'P/L (pts)':<12}")
        print("-" * 120)
        ...
        for signal in signals:
            ...
            print(f"{signal_date:<20} {signal['price']:<10.2f} {signal['rsi']:<8.1f} {signal['type']:<10} {signal['quality_score']:<8} {signal['risk_reward_ratio']:<8.2f} {signal['adx_value']:<8.1f} {status:<12} {profit:<12.4f}")
